...
class AssessmentStep1 extends StatelessWidget {
  const AssessmentStep1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Avaliação do comportamento vocal'),
      ),
      body: Padding(
